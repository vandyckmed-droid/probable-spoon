...
_METHODOLOGY_BODY = (
    ...
    'enterprise value = market_cap + totalDebt − cash. Same component-level '
    'winsorise-and-z-within-sector treatment as Quality (with the same '
    'small-sector fallback), then a universe-wide winsorise + z-score on '
    'the weighted composite so Value_z is comparable to Momentum_z and '
    'Quality_z before the MQV combine.</p>'
